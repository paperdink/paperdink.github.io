...
\u003cli\u003eYou should be able to see ESP32 Arduino boards in \u003ccode\u003eTools \u0026gt; Board\u003c/code\u003e\u003c/li\u003e
...
\u003cp\u003eCheckout this tutorial from random nerd tutorials \u003ca href="https://randomnerdtutorials.com/install-esp32-filesystem-uploader-arduino-ide/"\u003ehere →\u003c/a\u003e\u003c/p\u003e
...
\u003cp\u003eIf windows is not able to recognize paperd.ink please install the CP210x driver by downloading the setup from the top menu \u003ca href="https://www.silabs.com/developers/usb-to-uart-bridge-vcp-drivers"\u003ehere →\u003c/a\u003e\u003c/p\u003e
...
\u003cp\u003e\u003cimg src="/images/paperd.ink_pinout.png" alt="paperd.ink pinout"\u003e\u003c/p\u003e
\u003col\u003e
...
\u003cli\u003eEXT GPIO2: P6\u003c/li\u003e
\u003cli\u003eEXT GPIO3: P7\u003c/li\u003e
\u003cli\u003ePCF I2C ADDR: 0x20\u003c/li\u003e
\u003c/ul\u003e
\u003ch6 id="lipo"\u003eLiPo\u003c/h6\u003e
\u003cul\u003e
\u003cli\u003eCharging indicator (low = charging): 36\u003c/li\u003e
\u003cli\u003eBattery Enable: 25\u003c/li\u003e
\u003cli\u003eBattery Voltage: 34\u003c/li\u003e
...
\u003cp\u003epaperd.ink is designed to be low power. To achieve this goal, the EPD, SD card and battery sense circuits are powered via a MOSFET.
...
to the display set EPD enable to high to reduce the power consumption.\u003c/p\u003e
\u003ch2 id="battery"\u003eBattery\u003c/h2\u003e
\u003cp\u003eBatteries have shipping issues in terms of regulations and need special arrangements
...
A battery with in-built protection circuit is recommended.\u003c/p\u003e
\u003cp\u003e\u003cimg src="/images/battery_connector.png" alt="paperd.ink battery"\u003e\u003c/p\u003e
